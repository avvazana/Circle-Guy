class Tile {
  ...
  getHTML(){
      ...
      if(pacman.dies) {
        pacman.dies = false;
        return "<div class='pacmanDies " + create_coord_class_string(xCoord, yCoord) + "'></div>";
      } else {
